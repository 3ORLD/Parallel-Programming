// Kernel to calculate histogram using local memory for efficiency
...
__kernel void calculateHistogram(__global const unsigned char* image,
    ...
    __local int localHist[256]; // Local memory for work-group histogram
...
// Blelloch prefix sum for cumulative histogram
...
// Hillis-Steele scan for alternative cumulative histogram
